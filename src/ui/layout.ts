...
export function createLayout(): LayoutElements {
  ...
  app.innerHTML = `
    ...
    <div id="control-group">
      ...
      <div id="step-btn" title="step once"><svg viewBox="0 0 24 24" fill="none"><path d="M6 4 L6 20 L18 12 Z" fill="#5a6b4a" opacity="0.7"/></svg></div>
  ...
  const els: LayoutElements = {
    ...
    stepBtn: g("step-btn"),
    speedSlider: g("speed-slider") as HTMLInputElement,
    speedLabel: g("speed-label"),
...
export function showToast(toast: HTMLElement, message: string, ms = 2000): void {
  ...
  toastTimers.set(toast, setTimeout(() => toast.classList.remove("visible"), ms));
}
